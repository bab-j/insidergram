...
<body>
	...
	<div class="modal modal-signin position-static d-block bg-light py-5"tabindex="-1" role="dialog" id="modalSignin"style="">
        <div class="modal-dialog" role="document" style="max-width: 1000px;">
            ...
            <div class="modal-content rounded-4 shadow align-items-md-center">
                ...
                <form action="user/insertFeed.do" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-6 modal-body p-5 pt-0">
                        ...
                        <div class="col-6" style="padding-left: 48px;padding-right: 48px;padding-bottom: 48px;">
                            <div class="form-floating mb-3">
                                <div class="row" style="display: flex;justify-content: center;align-items: center;">
                                    ...
                                    <div class="row" style="margin-top: 25px;">
										<div style="text-align: center; font-weight: bold; font-size: 18px; text-align: left;" 
                                ...
                                <div class="row" style="margin-top: 25px;">
                                    <div class="col-6">
                                        <a
                                            ...
                                            style="border-color: silver;" type="reset" href="javascript:history.back()">
                                            <svg class="bi me-1 " width="0px" height="16"></svg>취소
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <input class="center_ailgn w-100 py-2 btn btn-outline-primary rounded-3" type="submit" value="수정" style="">
                                        
                                    </div>
                                    <div class="Col-12"><h5 style="color: white; margin-bottom: -15px;">.</h5></div>

		...
		<div class="row" >
			...
			<li class="col-2 text-center p-2">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid-3x3" viewBox="0 0 16 16">
				  ...
				  </svg>&nbsp;<a style="font-weight: bold; text-decoration: none;color: inherit;" href="#">PIC</a>
			</li>
			<li class="col-2 text-center p-2">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
				  ...
				  </svg>&nbsp;<a style="color: #6c757d; text-decoration: none;color: inherit;" href="#">DOC</a>
			</li>
			<li class="col-2 text-center p-2">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-star" viewBox="0 0 16 16">
				  ...
				  </svg>&nbsp;<a style="color: #6c757d; text-decoration: none;color: inherit;" href="#">SAVED</a>
			</li>
			<li class="col-3"></li>
		</div>
	</div>
								...
								<div style="width: 600px;height: 424px;overflow-y: auto; background-color: white;">
									...
									style="border: none; height: 100px; margin-top: 0px;">
										...
										<div class="d-flex gap-2 w-100 justify-content-between">
										  <div>
											<h6 class="mb-0">tldhsrkwhr11(본인)</h6>
											<p class="mb-0 opacity-75" style="padding-top: 10px; width: 300px;"> 그건 바로 </p>
										  </div>
										  <small class="opacity-50 text-nowrap">3분전</small>
										</div>
									</a>
									...
									style="border: none; height: 100px; margin-top: 0px;">
										...
										<div class="d-flex gap-2 w-100 justify-content-between">
										  <div>
											<h6 class="mb-0">tldhsrkwhr11(본인)</h6>
											<p class="mb-0 opacity-75" style="padding-top: 10px; width: 300px;"> 몽키D 루피 </p>
										  </div>
										  <small class="opacity-50 text-nowrap">3분전</small>
										</div>
									</a>
					...
					<div class="container" style="margin: 0px;padding: 0px;width: 1200px;height: 550px;">
						<div class="row square" style="margin: 0px;padding: 0px;width: 1200px;height: 550px;">
							...
							<div class="col-6" style="margin: 0px;padding: 0px;height: 550px;">
								...
								<img src="./img_src/test/3.jpg" class="card-img-top" style="height: 550px;border-radius: 0px;">
								...
								<div style="width: 600px;height: 424px;overflow-y: auto; background-color: white;">
									...
									style="border: none; height: 100px; margin-top: 0px;">
										...
										<div class="d-flex gap-2 w-100 justify-content-between">
										  <div>
											<h6 class="mb-0">tldhsrkwhr11(본인)</h6>
											<p class="mb-0 opacity-75" style="padding-top: 10px; width: 300px;"> 해적왕이 될.. </p>
										  </div>
										  <small class="opacity-50 text-nowrap">3분전</small>
										</div>
									</a>
									...
									style="border: none; height: 100px; margin-top: 0px;">
										...
										<div class="d-flex gap-2 w-100 justify-content-between">
										  <div>
											<h6 class="mb-0">tldhsrkwhr11(본인)</h6>
											<p class="mb-0 opacity-75" style="padding-top: 10px; width: 300px;"> 남자다! </p>
										  </div>
										  <small class="opacity-50 text-nowrap">3분전</small>
										</div>
									</a>

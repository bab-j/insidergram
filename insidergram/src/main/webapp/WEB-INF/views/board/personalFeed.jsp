...
<body
	...
	${userVO }
	<br> 글 게시물 갯수 : ${docPost.size() }
	<br> 사진 게시물 갯수 : ${picPost.size() }
	<br> 즐겨찾기 게시물 : ${saveFeed }
	<br> 팔로잉 : ${followingList }
	<br> 팔로워 : ${followerList }
	<%
																	...
																	<div class="d-flex gap-2 w-100 justify-content-between">
																		<div>
																			...
																			<p class="mb-0 opacity-75"
																				style="padding-top: 10px; width: 300px; font-size: 15.5px">${picList.content }</p>
																		</div>
																		<fmt:parseDate value="${picListst.regdate}"
																			var="postRegdate" pattern="yyyyMMdd" />

																		<small class="opacity-50 text-nowrap"> <fmt:formatDate
																				value="${postRegdate}" type="both" pattern="mm.dd" />
																			${postRegdate }
																		</small>
																	</div>
														...
														<div class="row square"
															...
															<div class="col-6"
																...
																<img src="../img_src/feed/${saveFeed.f_pic }"
																	class="card-img-top"
																	style="width: 50%; height: 100%; border-radius: 0px;">
															</div>
															...
															<div class="col-6"
																...
																<a href="/otherFeed.do"
																	class="d-flex align-items-center flex-shrink-0 p-3 link-dark text-decoration-none border-bottom text-center"
																	style="height: 80px; background-color: white;"> <img
																	src="../img_src/profile/${userVO.u_pic }" width="40"
																	height="40" class="rounded-circle flex-shrink-0"
																	style="margin-left: 20px;">
																	<div class="d-flex gap-2 w-100 justify-content-between">
																		<div>

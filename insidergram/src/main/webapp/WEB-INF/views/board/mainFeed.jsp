									...
									<c:choose>
										<c:when test="${save }">
											<a href="javascript:saveFeed(${feed.f_idx })"
												...
												<span id="emptySave${feed.f_idx }"
												class="material-icons-outlined"
												style="display: none; float: right; margin: 0px 10px 0px 0px;"> bookmark_border </span>
											</a>
										</c:when>
										<c:otherwise>
											<a href="javascript:saveFeed(${feed.f_idx })"
												...
												<span id="emptySave${feed.f_idx }"
												class="material-icons-outlined"
												style="display: inline; margin: 0px 10px 0px 0px;">	bookmark_border </span>

				...
				var dispHtml = "";
				 ...
				 $.each(
						...
						function(index, obj) {
									...
									dispHtml += '<a href="otherFeed.do?u_id=' + obj.u_id + '" class="d-flex align-items-center flex-shrink-0 p-3 link-dark text-decoration-none border-bottom text-center" style="background-color: white;">'
									...
									/* <!-- 버튼 클릭시 팝업창 오픈 --> */
									dispHtml += '<a style="margin-left: 10px; href="javascript:modalAjax(' + obj.f_idx + ')"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat" viewBox="0 0 16 16">'
									...
									if (saveList.includes(obj.f_idx)) {
										...
										dispHtml += '</a>'
										dispHtml += '<a href="javascript:saveFeed(' + obj.f_idx + ')" style="padding: 3px 0 0 38px">'
...
%>
								...
								<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ 메시지 버튼 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
									<a style="margin-left: 10px;" href="javascript:modalAjax(${feed.f_idx })"> 
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat" viewBox="0 0 16 16" onclick="">

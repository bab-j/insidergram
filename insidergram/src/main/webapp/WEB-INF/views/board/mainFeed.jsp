					...
					<div class="row col-6" id="k1" style="-bs-gutter-x: 0;">
						...
						<div class="col-12">
							<a href="getIndiFeed.do?u_id=${feed.u_id }"
								...
								<img src="../img_src/profile/${userVO.u_pic } " width="40"
								height="40" class="rounded-circle flex-shrink-0" style="border-radius: 70%">
						...
						<div class="col-12" style="margin-top: 10px; margin-bottom: 10px;">
							...
							<a style="margin-left: 20px;"> <!-- 하트 버튼 --> <svg
						...
						<path
							...
							<!-- 버튼 클릭시 팝업창 오픈 -->
							<label for="popup1"> <a style="margin-left: 10px;"> <!-- 메시지 버튼 -->
							...
							<a style="margin-left: 45px;"> <!-- 저장하기 버튼 --> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
						...
						<path
							...
							<div class="contentBox">${feed.content }</div>
						</div>
					</div>
				</c:forEach>
			</c:otherwise>
